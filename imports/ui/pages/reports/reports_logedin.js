...
import exportReport from "./report_export";
...
Template.reports_logedin.onRendered(function() {
  skipCount.set(0);
  currentPage.set(0);
  searchTerm.set("");
...
Template.reports_logedin.events({
...
Template.reports_logedin.helpers({
  serviceAddPath() {
...
Template.report_guest_item.helpers({
  PageNumbers(index) {
    return skipCount.get() + index + 1;
  }
});

Template.report_guest_list.onRendered(function() {
  this.autorun(() => {
    this.$(".tooltip-icon").tooltip({ delay: 50 });
...
Template.report_guest_list.helpers({
...
Template.report_guest_list.events({
...
Template.report_guest_item.onCreated(function() {});

Template.report_guest_item.onRendered(function() {});

Template.report_guest_item.helpers({});

Template.report_guest_item.events({

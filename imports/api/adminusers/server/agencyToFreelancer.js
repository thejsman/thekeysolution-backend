    ...
    <html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml">
      ...
      <body>
        ...
        <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;">
          ...
          <div>&nbsp;</div>
          <div>In an endeavor towards a more streamlined digital cohesion of managing the event, we’d like to invite you to log-in to our <a href="${ domain }/public/invite/${ type }/${ token }">Key Workstation</a>.</div>
          ...
          <div>P.S.: In case you are having difficulties logging-in, please contact our Agency representative via email or call.</div>
